...
<page style="font-size: 10pt">
    ...
    <br>
    <small>Texte ̩crit avec small</small>, Texte ̩crit normalement, <big>Texte ̩crit avec big</big><br>
    ...
    <table style="background: #FFAAAA; color: #000022; border: 3px solid #555555;">
        <tr>
            <td style="width: 40mm; border: solid 1px #000000; background-image: url(./res/off.png); background-position: left top; background-repeat: repeat; color: #003300">Case A1</td>
            <td style="width: 50mm; border: solid 1px #000000; background-image: url(./res/off.png); background-position: left top; background-repeat: repeat; font-weight: bold;">Case A2</td>
            <td style="width: 60mm; border: solid 1px #000000; background-image: url(./res/off.png); background-position: left top; background-repeat: repeat; font-size: 20px;">Case A3</td>
        </tr>
        <tr>
            <td style="border: solid 1px #000000; text-align: left;   background-image: url(./res/off.png); background-position: left top; background-repeat: repeat; vertical-align: top; ">Case B1</td>
            <td style="border: solid 1px #000000; text-align: center; background-image: url(./res/off.png); background-position: left top; background-repeat: repeat; vertical-align: middle; height: 20mm">Case B2<hr style="color: #22AA22">test de hr</td>
            <td style="border: solid 1px #000000; text-align: right;  background-image: url(./res/off.png); background-position: left top; background-repeat: repeat; vertical-align: bottom; border-radius: 3mm; ">Case B3</td>
        </tr>
    </table>
    <br>
