    ...
    <table cellspacing="2mm">
        ...
        <tr>
            <td colspan="3" align="center">
                <span class="titre"><br>Recus de paiement d'une tranche</span><br>
                <span class="">Receipt of payment of a tranche</span><br><br>
        ...
        <tr>
            <td colspan="3" >
                ...
                <br>Frais de l'enseignement : <b><?php echo $registration->fees ?> FCFA</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
                <br>Montant versé précedement : <b><?php echo $fees['lastFees'] ?> FCFA</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
                <br>Montant nouvellement versé : <b><?php echo $fees['newFees'] ?> FCFA</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
                <br>Montant total versé : <b><?php echo $fees['actualFees'] ?> FCFA</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
                <br>Montant restant &aacute; verser : <b><?php echo $fees['restFees'] ?> FCFA</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br>
            </td>
        </tr>
        <tr>
            <td colspan="3">
