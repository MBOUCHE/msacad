...
<input type="hidden" id="link" value="<?php echo base_url('trainner/registration/qrValidationModal/') ?>" />
<input type="hidden" id="slink" value="<?php echo base_url('trainner/registration/payInstallement') ?>" />
