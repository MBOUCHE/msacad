        ...
        <div class="row">
            <div class="col-sm-12 offset-md-3 col-md-6">
                ...
                <form action="getRegInfos" method="post"  class="w3-round w3-card-2" style="padding: 20px !important;">
                    ...
                    <hr>
                    <a href="<?php echo base_url('trainner/registration/qrValidation/')?>" type="button" id="qrVal" class="btn w3-btn w3-blue btn-primary w3-center"><i class="fa fa-check-circle fa-fw"></i> Valider le code QR</a>
                </form>
            </div>
        </div>
    </div>
