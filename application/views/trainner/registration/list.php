    ...
    <div class="container-fluid">
        ...
        <div class="row w3-margin-top">
            <div class="col-sm-12 col-md-3 w3-margin-bottom">
                <a href="<?php echo base_url('trainner/registration/addRegistration')?>" class="w3-btn w3-blue w3-round">Ajouter une inscription</a>
            </div>
        </div>
                ...
                <div class="row">
				 ...
				 $class="";
                                ...
                                if (($reg['fees']-$reg['installment'])!=0 && $reg['state']!='0')
                                    echo "<a href=".base_url('trainner/registration/payInstallement')."/".$reg['regId']."/".$reg['userId']." class='lock w3-btn w3-white w3-small w3-margin-small' title=\"Payer une tranche\">
