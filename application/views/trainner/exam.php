                ...
                foreach ($list as $key ) {?>
                    <div class="col-xl-4 col-sm-8 mb-4">
                        <div class="card card-inverse card-success o-hidden h-100">
                            ...
                            <a href="<?php echo base_url('trainner/Planning_exam/generate')?>?name=<?php echo $key['id_wave']?>" class="card-footer clearfix small z-1">
                                <span class="float-right" style="color:white;font-size: 13px;">faire un planning d'examen &ensp;<span class="fa fa-angle-right"></span>
                            </a>
                        </div>
                    </div>
             <?php   }
