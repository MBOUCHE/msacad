    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-3">
                <a href="<?php echo base_url('trainner/student')?>" class="w3-btn w3-blue w3-round">Tous les apprenants</a>
            </div>
            <div class="col-sm-12 col-md-6">
                ...
                ?>
                <form action="<?php base_url("trainner/student/formAdd") ?>" method="post" class="">
                    <div class="row">
                        <div class="col-sm-12">
