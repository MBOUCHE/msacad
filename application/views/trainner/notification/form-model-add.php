    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-3 w3-margin-bottom">
                <a href="<?php echo base_url('trainner/notification/allModel')?>" class="w3-btn w3-blue w3-round">Tous les models</a>
            </div>

            <div class="offset-2 col-8">
                <?php if(isset($model)){ ?>
                    <form action="<?php echo base_url('trainner/notification/modify/'.$model->id)?>" method="post">
                        <h3 for="notif" class="">Votre notification: </h3><br>
                        <textarea name="my_notif"><?php echo $model->content ?>
                <?php }else{ ?>
                    <form action="<?php echo base_url('trainner/notification/formAdd')?>" method="post">
