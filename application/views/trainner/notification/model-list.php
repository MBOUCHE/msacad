<div class="content-wrapper py-3">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-3 w3-margin-bottom">
                <a href="<?php echo base_url('trainner/notification/formAdd')?>" class="w3-btn w3-blue w3-round">Ajouter un model</a>
            </div>
    ...
    <script>
        ...
        function publish($this){
            ...
            $.post('<?php echo base_url('trainner/notification/modalPublishContent')?>', {mode: 'js', notif: idDoc}, function(rep){
                    $.loader('close');
