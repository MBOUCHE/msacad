                        ...
                        <table class="table table-bordered table-hover small dataTable" width="100%" cellspacing="0">
                            ...
                            <?php
                                ...
                                foreach($result['lesson'] as $liste)
                                {
                                    ...
                                    echo '<td>
                                            <a href='.base_url('trainner/lesson/modify/'.$liste->id).' title="modifier!" class="lock w3-btn w3-white w3-small w3-margin-small"><i class="fa fa-pencil fa-2x w3-text-black"></i></a>
                    ...
                    <div class="col-sm-12 table-responsive w3-margin-top">
                        ...
                        <table class="table table-bordered table-hover small dataTable" width="100%" cellspacing="0">
                            ...
                            foreach ($result['registration'] as $reg)
                            {
                                ...
                                if($reg['state']!=-1)
                                    echo "<a href=".base_url('trainner/registration/printQuitus')."/".$reg['regId']." class='w3-btn w3-white w3-margin-small' title=\"Imprimer le quitus\">
                                                <i class='fa fa-print fa-2x w3-text-blue'></i>
                                              </a>";
                                if (($reg['fees']-$reg['installment'])!=0)
                                    echo "<a href=".base_url('trainner/registration/payInstallement')."/".$reg['regId']."/".$reg['userId']." class='w3-btn w3-white w3-small w3-margin-small' title=\"Payer une tranche\">
    ...
    <script>
        ...
        function shelve($this){
            ...
            alertify.confirm(
                ...
                + '</p>',
                function(){
                    $(location).attr('href', '<?php echo base_url('trainner/registration/shelveRegistration') ?>'+'/'+idReg);
