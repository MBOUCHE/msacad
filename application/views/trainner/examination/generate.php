    ...
    <div class="container-fluid">
        ...
        <div class="row w3-margin-top">
            <div class="col-sm-12 col-md-3 w3-margin-bottom">
                <a href="<?php echo base_url('trainner/examination/planning')?>" class="w3-btn w3-blue w3-round">Tous les emplois du temps</a>
            </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        /*$('#send').on('click', function () {
            var form=$('form');
            //form.prop('action', "<-?php echo base_url('trainner/examination/planning/generate/') ?>");
            form.submit();
        });*/
