    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="offset-2 col-8">
                ...
                <?php } ?>
                <form action="<?php echo isset($req[0]->id) ?(base_url("material/save") ."/".  $req[0]->id) ."/add" : base_url("material/lyst") ?>" method="post">
                    <div class="row">
                        <div class="col-sm-6">
                    ...
                    <button type="submit" name="send" class="w3-btn w3-blue w3-round">Ajouter</button>
                </form>
            </div>
        </div>
    </div>
