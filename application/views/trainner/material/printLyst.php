    ...
    <table border='1'>
        ...
        for($i = 1; $i <= count($material); $i++)
        {
            ...
            echo '<td>
                                    ...
                                    <a href="'.base_url("trainner/material/materialAction").'/'.$material[$i-1]->id.'/add" title="Ajouter du materiel!" class="btn btn-primary"><i class="fa fa-plus-square"></i></a>
                                    <a href="'.base_url("trainner/material/materialAction").'/'.$material[$i-1]->id.'/remove" title="retirer du materiel!" class="btn btn-primary"><i class="fa fa-minus-square"></i></a>
