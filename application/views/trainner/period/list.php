    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-3">
                <a href="<?php echo base_url('trainner/period/formAdd')?>" class="w3-btn w3-blue w3-round">Ajouter une période</a>
            </div>
        </div>
                ...
                <table class="table table-bordered table-hover" width="100%" id="dataTable" cellspacing="0">
                    ...
                    <tbody id="table">
                        <?php
                            ...
                            {
                                echo '<tr><td colspan="3"  class="h3 text-center"><a href="'.base_url('trainner/period/save').'" class="text-warning">Aucune période enregistré pour le moment ...</a><td></tr>';
                            }
                        ?>
                    </tbody>
                </table>
...
<script>
    $(document).ready(function(){
       ...
       $('#send').mouseover(function(){
          $(this).attr('href', '<?php echo base_url('trainner/period/savePeriod') ?>/'+$('#type').val());
       });
