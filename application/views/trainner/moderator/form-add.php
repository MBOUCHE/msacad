    ...
    <div class="container-fluid">
        <div class="row">
            <div class="h4 text-center col-sm-12">
                <?php echo mb_strtoupper('Enregistrer un modérateur') ?>
        ...
        <div class="row w3-margin-top">
            <div class="col-sm-12 col-md-3 w3-margin-bottom">
                <a href="<?php echo base_url('trainner/moderator')?>" class="w3-btn w3-blue w3-round">Tous les modérateurs</a>
            </div>
            ...
            <div class="col-sm-12 col-md-6">
                ...
                ?>
                <form action="<?php echo base_url('trainner/moderator/formAdd') ?>" method="post" class="">
                    <div class="row">
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-12">
                            <div class="input-group">
                                ...
                                <select name="nationality" id="nationality" value="<?php echo set_value('nationality') ?>" class="form-control">
                                    <option value="" disabled selected>Choisissez votre pays d'origine...</option>
                                </select>
                            </div>
                            <?php echo form_error('birthPlace') ?>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="input-group">
                                ...
                                <input type="text" name="phone" id="phone" max="16" value="<?php echo set_value('phone') ?>" class="form-control" autocomplete="off"><br>
                            </div>
                    ...
                    <button type="submit" name="send" class="btn w3-btn w3-blue btn-primary"><i class="fa fa-fw fa-save"></i> Enregistrer</button>
                </form>
            </div>
        </div>
