...
<head>
    ...
    <title><?php echo (isset($titre) and $titre)? ($titre.' | FORMATEUR '.APPNAME) : (' FORMATEUR| ADMINISTRATION '.APPNAME) ?></title>
    ...
    <link href="<?php echo css_url('datetimepicker/jquery.datetimepicker')?>" rel="stylesheet">
    ...
    <script src="<?php echo js_url('jquery.datetimepicker')?>"></script>
