    ...
    <div class="container-fluid">
        <div class="row">
            <div class="h4 text-center col-sm-12">  
                <p style="color:red;font-size:30px;font-family:Niconne">Mes vagues</p>
                        ...
                        <div class="card card-inverse card-primary o-hidden h-100">
                            <div class="card-block">
                                <div class="card-block-icon">
                                    <i class="fa fa-fw fa-lemon-o" style="color:#7fffd4 "></i></div>
                            ...
                            <a href="<?php echo base_url('trainner/modules')?>?vague=<?php echo $key['id_wave']?>" class="card-footer clearfix small z-1"> 
                                <span class="float-right" style="color:white;font-size: 13px;">Detail &ensp;<span class="fa fa-angle-right"></span>
                            </a>
                        </div>
                    </div>
             <?php   }
