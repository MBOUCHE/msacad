...
<page format="A4" orientation="L" backtop="8mm" backleft="8mm" backright="10mm" backbottom="8mm">
    ...
    <table class="bordered" width="100%" id="" cellspacing="0">
            ...
            <tbody>
                  ...
                  <tr>
                    ...
                    <td> <?php echo $inscription['num_slice'].'/'.$inscription['total_slice']; ?> </td>
