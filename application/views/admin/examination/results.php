    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-sm-12 table-responsive">
                <a target="_blank" href="<?php echo base_url('admin/examination/results/'.$promotion->promotion->code.'/'.$evaLink.'/print')?>" id="print" type="button" class="w3-btn btn w3-blue w3-margin-bottom"><i class="fa fa-fw fa-print"></i>  Imprimer</a><br>
