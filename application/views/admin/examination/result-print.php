...
<page format="A4" orientation="paysage">
    <table style="width:100%;">
        ...
        <tr>
            <td colspan="3" align="center">
                <?php if ($all) { ?>
                    ...
                    <span class="h4 bold">SESSION DE <?php echo  mb_strtoupper(moment($session[0]->date)->format('F Y')); ?></span>
                    <br>
                    <br>
                <?php } else { ?>
        ...
        <tr>
            <td colspan='3' align="center" class='italic'> Liste par ordre alphabétique </td>
        </tr>
    </table>
    ...
    <table class="edt" style="width: 100%">
        <tr>
            ...
            <td><b>N°</b></td>
            <td class="col-4"><b>Matricule</b></td>
            <td class="col-1"><b>Nom(s) et prénom(s)</b></td>
            <?php
            if ($all)
                foreach ($evals as $ev)
                {
            ...
            ?>
            <td class="col-2"><b>Appréciation</b></td>
            <?php
            if ($all) { ?>
