    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-3 w3-margin-bottom">
                <a href="<?php echo base_url('admin/period')?>" class="w3-btn w3-blue w3-round">Toutes les périodes</a>
            </div>

            <div class="col-md-6">
                <form class="form-horizontal" action="<?php echo base_url('admin/period/formAdd') ?>" method="post">
