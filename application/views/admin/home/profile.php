    ...
    <div class="container-fluid">
        <div class="row">
            <div class="h4 text-center  col-sm-12">
                <?php echo mb_strtoupper('Votre profil administrateur')?>
                <br> <b><?php echo ucfirst($user->firstname).' '.mb_strtoupper($user->lastname) ?></b>
        ...
        <div class="row">
            <div class="row col-md-12 float-right">
                ...
                <div class="col-md-4">
                    <a href="<?php echo base_url("admin/home/editProfile")?>" type="button" class="w3-btn w3-blue w3-round btn-block"><h4><i class="fa fa-edit"></i> Modifier</h4></a>
                </div>
                <div class="col-md-4">
            ...
            <div class="row col-md-12">
                <div class="col-md-4">
                    ...
                    <form class="text-center" action="<?php echo base_url('admin/home/profile') ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
