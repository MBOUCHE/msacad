        ...
        <div class="row">
            ...
            <div class="col-sm-12 table-responsive">
                <table class="table table-bordered table-hover small" width="100%" id="dataTable" cellspacing="0">
                    ...
                    {
                        echo '<tr><td colspan="6"  class="h4 text-center"><a href="'.base_url('admin/trainer/addTrainer').'" class="text-warning">Aucun formateur enregistré pour le moment ...</a><td></tr>';
                    }
                    ?>
                    </tbody>
                </table>
    ...
    <script type="text/javascript">
        ...
        function unshelve($this){
            ...
            alertify.confirm(
                ...
                + '</p>',
                function(){
                    $(location).attr('href', '<?php echo base_url('admin/trainer/shelve') ?>'+'/'+idLa);
                }
        ...
        function shelve($this){
            ...
            alertify.confirm(
                ...
                + '</p>',
                function(){
                    $(location).attr('href', '<?php echo base_url('admin/trainer/unshelve') ?>'+'/'+idLa);
                }
