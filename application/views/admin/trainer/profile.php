    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="row col-md-12 float-right">
                ...
                <div class="col-md-4">
                    <a href="<?php echo base_url("admin/trainer/profile").'/'.$trainer->user.'/print' ?>" type="button" class="w3-btn w3-blue w3-round btn-block"><h4><i class="fa fa-id-card-o"></i> Imprimer le profil</h4></a>
                </div>
                <div class="col-md-4">
            ...
            <div class="row col-md-12">
                <div class="col-md-4">
                    ...
                    <form class="text-center" action="<?php echo base_url('admin/trainer/profile').'/'.$trainer->user ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
