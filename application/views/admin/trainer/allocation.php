    ...
    <div class="container-fluid">
        ...
        <div class="row w3-margin-top">
            <div class="col-sm-12 col-md-3 w3-margin-bottom">
                <a href="<?php echo base_url('admin/trainer/all')?>" class="w3-btn w3-blue w3-round">Tous les formateurs</a>
            </div>
            ...
            <div class="col-sm-12 col-md-6" style="min-height: 500px">
                ...
                ?>
                <form action="<?php echo base_url('admin/trainer/allocation')?>" method="post" class="">
                    <?php
                    if(isset($user))
                    {
                    ?>
