                ...
                <table class="table table-bordered table-hover small" width="100%" id="dataTable" cellspacing="0">
                    ...
                    if(isset($query) And is_array($query) and !empty($query))
                    {
                        ...
                        for($i = 1; $i <= count($query); $i++)
                        {
                            ...
                            echo '<td>
                                    <a href="'.base_url('admin/trainer/lessons').'/'.$query[$i-1]->id.'" title="Cour(s) dispensé(s)"><i class="w3-btn fa fa-2x fa-list text-info" aria-hidden="true"></i></a>
                                    <a href="'.base_url('admin/trainer/profile').'/'.$query[$i-1]->id.'" title="Profil"><i class="w3-btn fa fa-2x fa-user w3-text-green" aria-hidden="true"></i></a>
                                    <a href="'.base_url('admin/trainer/log').'/'.$query[$i-1]->id.'"><i class="w3-btn fa fa-2x fa-bookmark red-tooltip" aria-hidden="true" style="cursor: pointer;" title="Log"></i></a>';
                            switch ($query[$i-1]->locked)
                            {
                                case '0':
    ...
    <script type="text/javascript">
        ...
        function unshelve($this){
            ...
            alertify.confirm(
                ...
                + '</p>',
                function(){
                    $(location).attr('href', '<?php echo base_url('admin/trainer/motivation') ?>'+'/shelve/'+idLa);
                }
        ...
        function shelve($this){
            ...
            alertify.confirm(
                ...
                + '</p>',
                function(){
                    $(location).attr('href', '<?php echo base_url('admin/trainer/motivation') ?>'+'/unshelve/'+idLa);
                }
