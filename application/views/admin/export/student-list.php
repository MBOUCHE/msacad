        ...
        <div class="row">
            ...
            if ($students!=null)  { ?>
                <div class="w3-margin-bottom w3-btn-group">
                    <a target="_blank" href="<?php echo base_url('admin/export/promotion/')."/".$promo->code."/students/certificate" ?>" class="w3-btn w3-blue w3-round"><i class="fa fa-certificate"></i>  Exporter les données pour certificats</a>
                    <a target="_blank" href="<?php echo base_url('admin/export/promotion/')."/".$promo->code."/students/attestation" ?>" class="w3-btn w3-green w3-round"><i class="fa fa-certificate"></i>  Exporter les données pour attestations</a>
                    <a target="_blank" href="<?php echo base_url('admin/export/promotion/')."/".$promo->code."/students/report" ?>" class="w3-btn w3-pink w3-round"><i class="fa fa-trophy"></i>  Exporter les données pour relevés de notes</a>
                </div>
                <?php } ?>
