    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-3 w3-margin-bottom">
                <a href="<?php echo base_url('admin/lesson/formAdd')?>" class="w3-btn w3-blue w3-round">Ajouter un enseignement</a>
            </div>
                        ...
                        <?php //LE&Ccedil;ONS
                            if(isset($query) And is_object($query))
                            {
                                ...
                                foreach($query->result() as $liste)
                                {
                                    ...
                                    echo '<td>
                                            <a href='.base_url('admin/lesson/edit/'.$liste->id).' title="modifier" class="lock w3-btn w3-white w3-small w3-margin-small"><i class="fa fa-pencil fa-2x w3-text-black"></i></a>
                            ...
                            {
                                echo '<tr><td colspan="6"  class="h3 text-center"><a href="'.base_url('admin/lesson/save').'" class="text-warning">Aucun enseignement enregistré pour le moment ...</a><td></tr>';
                            }
                        ?>
                    </tbody>
                </table>
