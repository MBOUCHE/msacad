    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-3 w3-margin-bottom">
                <a href="<?php echo base_url('admin/document/formUpload')?>" class="w3-btn w3-blue w3-round">Ajouter des documents</a>
            </div>
            ...
            <div class="col-sm-12 w3-responsive">
                <table class="table w3-table-all small" width="100%" id="dataTable" cellspacing="0">
                    ...
                    {
                        echo '<tr><td colspan="6"  class="h3 text-center"><a href="'.base_url('admin/document/formUpload').'" class="text-warning">Aucun document enregistré pour le moment ...</a><td></tr>';
                    }
                    ?>
                    </tbody>
                </table>
