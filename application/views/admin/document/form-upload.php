    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-3 w3-margin-bottom">
                <a href="<?php echo base_url('admin/document/all')?>" class="w3-btn w3-blue w3-round">Tous les documnets</a>
            </div>
            <div class="container">
                <form action="<?php echo base_url('admin/document/formUpload') ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
