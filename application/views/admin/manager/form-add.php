    ...
    <div class="container-fluid">
        ...
        <div class="row w3-margin-top">
            <div class="col-sm-12 col-md-3 w3-margin-bottom">
                <a href="<?php echo base_url('admin/manager')?>" class="w3-btn w3-blue w3-round">Tous les gérants</a>
            </div>
            ...
            <div class="col-sm-12 col-md-6">
                ...
                ?>
                <form action="<?php echo base_url('admin/manager/formAdd') ?>" method="post" class="">
                    <div class="row">
                        <div class="col-sm-6">
