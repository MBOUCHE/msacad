    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-3 w3-margin-bottom">
                <a href="<?php echo base_url('admin/session/generateTimetable')?>" class="w3-btn w3-blue w3-round">Générer un emploi du temps</a>
            </div>
            ...
            <div class="col-sm-12 table-responsive">
                <table class="table table-bordered table-hover small" width="100%" id="dataTable" cellspacing="0">
                    ...
                    foreach ($timetables as $tb)
                    {
                        ...
                        echo "<td>
                                  <a href='".base_url('admin/session/timetable')."/$sd' id='$sd' class='w3-btn w3-white w3-margin-small'  title=\"visualiser\" target=\"_blank\"><i class='fa fa-search fa-2x w3-text-blue'></i></a>
...
<script type="text/javascript">
    function delTb($this){
        ...
        alertify.confirm("Suppression de l'emploi du temps", "Êtes-vous sûr de vouloir supprimer cet emploi du temps?",
            function(){
                window.location.href="<?php echo base_url('admin/session/timetableDelete/') ?>"+'/'+id;
            },
            function(){
