...
<div style="min-width:700px; max-width: 880px; font-family: Oxygen;" class="w3-margin">
    <div class="left">
        <table>
            <tr><td class="text-center">Promotions</td></tr>
        ...
        <table>
            ...
            <?php
                ...
                foreach ($periods as $period){
                    $line++;
                    $day=0;
                    echo "<tr id=\"".$period->id."\">";
                    echo '<td class="time w3-light-green w3-text-white ">'.$period->start.':00-'.$period->end.':00'.'</td>';
    ...
    $(function(){
        ...
        function tryTime()
        {
            ...
            program.forEach(function (item) {
                prog+='{"day": '+item[0]+', "period": '+item[1]+', "promotion": "'+item[2]+'"},';
                //prog+='{"day": '+item[0]+', "period": '+item[1]+', "promotion": "'+item[2].slice(2)+'"},';
            });
            var txt=prog.split("");
            txt.pop();
            prog=txt.join('');
