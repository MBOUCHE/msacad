    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6">
                <a href="<?php echo base_url('admin/session/printTimeTable/'.$timetableStartDate) ?>" class="w3-right w3-btn w3-blue w3-round" target="_blank"><i class="fa fa-print w3-text-white" aria-hidden="true"></i> Imprimer</a>
            </div>
