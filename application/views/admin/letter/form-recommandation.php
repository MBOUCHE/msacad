    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="offset-md-3 col-md-6">
                <form class="form-horizontal" action="<?php base_url('admin/letter/recommandationLetter') ?>" method="post">
    ...
    $(document).ready(function(){
        ...
        $("#nomA").keyup(function(){
            var val = $(this).val();
                ...
                $.ajax({
                    type : "POST",
                    url : "<?php echo base_url('admin/letter/searchVal'); ?>",
                    data : data,
                        ...
                        if(server_response[1]=='{') {
                            ...
                            $("#nomA").autocomplete({
                                ...
                                select: function (event, ui) {
                                    ...
                                    $.ajax({
                                        type : "POST",
                                        url : "<?php echo base_url('admin/letter/searchLesson'); ?>",
                                        data : data,
                                        success : function(server_response){
