        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    ...
                    <form class="text-center" style="width: 100%" action="<?php echo base_url('memberGate/home/profil') ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                ...
                <div class="col-md-8">
                    ...
                    <div class=" col-md-9 col-lg-9 ">
                        <table class="table table-user-information">
                            ...
                            <tr>
                                <td><?php echo mb_strtoupper("é").'tablissement' ?></td>
                ...
                <div class="col-md-12">
                    <a href="<?php echo base_url("memberGate/home/editProfile")?>" type="submit" name="send" class="btn w3-btn w3-blue btn-primary w3-right"><i class="fa fa-fw fa-pencil"></i> Modifier</a>
                </div>
