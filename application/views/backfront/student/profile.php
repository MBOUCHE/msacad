            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <h5>Photo</h5>
                        ...
                        <form class="text-center" style="width: 100%" action="<?php echo base_url('studentGate/home/profil') ?>" method="post" enctype="multipart/form-data" accept-charset="utf-8">
                ...
                <div class="col-md-12">
                    <a href="<?php echo base_url("studentGate/home/editProfile")?>" type="submit" name="send" class="btn w3-btn w3-blue btn-primary w3-right"><i class="fa fa-fw fa-pencil"></i> Modifier</a>
                </div>
