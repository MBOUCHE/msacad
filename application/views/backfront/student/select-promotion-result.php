...
<div id="content">
    <div class="inner" style="min-height: 700px;">
        <div class="row">
            <div class="col-lg-12 text-center" style="margin: 0 !important">
                        ...
                        foreach ($promotions as $promo)
                        {
                            if ($promo->results!=null){
                                foreach ($promo->results as $res) {
                                    ...
                                    echo "<td><a href='" . base_url('StudentGate/examination/results/') . '/' . $promo->promotion->code . '/' . permalink($res->code) . "' class='btn btn-primary btn-sm'>Afficher</a></td>";
                                    echo "</tr>";
                                }
                            }
