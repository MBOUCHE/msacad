        ...
        <div class="container">
            <div class="row">
                <div class="h4 text-center col-sm-12 w3-margin-top">
                    <?php echo mb_strtoupper('Enregister une nouvelle') ?>
                ...
                <div class="w3-padding-large">
                    <div class="w3-row">
                        <div class="col-sm-12 w3-margin-bottom">
                            <a class="w3-btn w3-blue" href="<?php echo base_url('moderatorGate/news') ?>">Liste des nouvelles</a>
                        </div>
                    </div>
                            ...
                            <div class="col-md-11">
                                ...
                                <div class="w3-row">
                                    <div id="content_image" class="col-xs-6 w3-responsive w3-centre <?php echo set_value('image')?'':'w3-hide' ?>" style="max-width: 450px;">
                                        ...
                                        <img style="" id="photo" src="" class="w3-hover-opacity w3-image w3-round" alt="Photo"  height="150" title="Cliquer pour changer" onclick='$("input[type=\"file\"]").trigger("click")'>
                                ...
                                <div class="input-group w3-margin-bottom">
                                    ...
                                    <textarea class="form-control" type="text" name="text"><?php echo set_value('text') ?></textarea>
                                </div>
                        ...
                        <div class="w3-row">
                            <div class="col-md-11">
                                <div class="w3-left custom-checkbox">
                                    <input type="checkbox" name="show_in_slide" class="checkbox w3-show-inline-block"> Afficher dans le slide
                                </div>
