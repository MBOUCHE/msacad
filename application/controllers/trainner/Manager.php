...
class Manager extends Ci_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('trainner/manager_model', 'manager');
    ...
    public function formAdd()
    {
        ...
        if($this->form_validation->run())
        {
            ...
            if(is_bool($postOk) And $postOk){
                ...
                redirect("trainner/manager");
            }
            else
            {
                $this->data['message'] = 'Echec d\'enregistrement: '.$postOk;
                $this->render('trainner/manager/form-add', 'Enregistrer un gérant');
            }
        } else
        {
            $this->render('trainner/manager/form-add', 'Enregistrer un gérant');
    ...
    public function all()
    {
        ...
        $this->render('trainner/manager/list', 'Liste des gérants');
    }
    ...
    {
    	protected_session(array('','trainner/auth'),array(TRAINER));
        $this->render('trainner/manager/addManager', 'Ajout d\'un gérant');
    }
    ...
    public function regManager()
    {
        ...
        if($this->form_validation->run()) {
            ...
            else
            {
                ...
                $this->render('trainner/manager/regManager', 'Ajout d\'un gérant');
            }
        } else
        {
            $this->data['users']=$this->manager->getNotManagers("lastname");
    ...
    public function motivation($mode = false, $idUr = false){
        ...
        if(($mode=="shelve" or $mode == "unshelve") and $idUr){
            ...
            if(is_array($manager)){
                ...
                $this->data['mode'] = $mode;
                $this->data['idUr'] = $idUr;
                $this->render('trainner/manager/motivation', 'Enregistrer la motivation');
            }else{
                redirect('trainner/manager');
            }
    ...
    public function log($id=false){
        ...
        $this->data['log'] = $log;
        $this->render('trainner/manager/log', 'Liste des logs');
    }
