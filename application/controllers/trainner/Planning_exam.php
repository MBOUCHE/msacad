...
class Planning_exam  extends Ci_Controller
{
    protected $data, $menu;
    ...
    public function index()
    {
        ...
        $this->load->view('trainner/exam', $lists);
    ...
    public function generate()
    {
        ...
        $lists['liste'] =$this->Courses->nbre1_cours($_GET['name']);
        $this->load->view('trainner/menu',$listes);
        $lists['list'] =$this->Courses->wave();
        $this->load->view('trainner/all_exam', $lists);
        $this->load->view('trainner/footerAdmin');
    }
}
