...
class Session extends CI_Controller
{
    ...
    function __construct()
    {
        ...
        $this->load->model('trainner/session_model', 'sessionm');
    ...
    public function showTimetable()
    {
        if (isset($_POST['start'])) {
            ...
            if ($nbrTime>0)
            {
                ...
                $this->render('trainner/timetable/generate', 'Générer un emploi du temps');
                ...
                $this->render('trainner/timetable/timetablePreview', 'Emploi du temps');
            }
        }
        else
        {
    ...
    public function timetable($timetableStartDate)
    {
        ...
        $this->render('trainner/timetable/timetable', 'Emploi du temps');
    }

    public function generateTimetable()
    {
        protected_session(array('','trainner/auth'),TRAINER);
        $this->render('trainner/timetable/generate', 'Générer un emploi de temps');
    }
    ...
    public function rapport()
    {
     $this->load->view('trainner/headerAdmin');
        ...
        $listes['liste'] =$this->Courses->wave();
        $this->load->view('trainner/menu',$listes);
        $lists['list'] =$this->Courses->rapport();
        $this->load->view('trainner/rapport',$lists);
        $this->load->view('trainner/footerAdmin');    }
    ...
    public function printTimeTable($timetableStartDate)
    {
        ...
        if($table!=null)
        {
            ...
            $content = $this->load->view('trainner/timetable/printTimetable', $this->data, true);
