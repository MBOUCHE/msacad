...
class Lesson extends CI_Controller {
    ...
    public function formAdd()
    {
        ...
        if($this->form_validation->run())
        {
            ...
            }else
            {
                ...
                $this->render('trainner/lesson/form-add', 'Enregistrer un enseignement');
            }
        }
        else
        {
    ...
    public function all()
    {
        ...
        $this->render('trainner/lesson/list', 'Liste des enseignements');
    }
    ...
    public function edit($id=false){
        ...
        $this->render('trainner/lesson/form-edit', "Modification de l'enseignement");
