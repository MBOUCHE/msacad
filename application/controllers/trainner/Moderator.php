...
class Moderator extends Ci_Controller
{
    ...
    public function __construct()
    {
        ...
        $this->load->model('trainner/moderator_model', 'moderator');
    ...
    public function formAdd()
    {
        ...
        if($this->form_validation->run())
        {
            ...
            if(is_bool($postOk) And $postOk){
                ...
                redirect("trainner/moderator");
            }
            else
            {
                $this->data['message'] = 'Echec d\'enregistrement: '.$postOk;
                $this->render('trainner/moderator/form-add', 'Enregistrer un modérateur');
            }
        } else
        {
            $this->render('trainner/moderator/form-add', 'Enregistrer un modérateur');
    ...
    public function all()
    {
        ...
        $this->render('trainner/moderator/list', 'Liste des modérateurs');
    }

    public function addModerator()
    {
        $this->render('trainner/moderator/addModerator', 'Ajout d\'un modérateur');
    }
    ...
    public function regModerator()
    {
        ...
        if($this->form_validation->run()) {
            ...
            else
            {
                ...
                $this->render('trainner/moderator/regModerator', 'Ajout d\'un modérateur');
            }
        } else
        {
            $this->data['users']=$this->moderator->getNotModerators("lastname");
    ...
    public function motivation($mode = false, $idUr = false){
        if(($mode=="shelve" or $mode == "unshelve") and $idUr){
            ...
            if(is_array($moderator)){
                ...
                $this->data['mode'] = $mode;
                $this->data['idUr'] = $idUr;
                $this->render('trainner/moderator/motivation', 'Entrez le motif');
            }else{
                redirect('trainner/moderator');
            }
    ...
    public function log($id=false){
        ...
        $this->data['log'] = $log;
        $this->render('trainner/moderator/log', 'Liste des logs');
    }
